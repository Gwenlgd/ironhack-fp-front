        ...
        {isLoggedIn ? (
          <>
            ...
            <p>
              <Link
                to="/inputs"
                className="mt-10 text-floral-white bg-green opacity-50 shadow-not-selected focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
              >
                All your inputs
              </Link>
            </p>
