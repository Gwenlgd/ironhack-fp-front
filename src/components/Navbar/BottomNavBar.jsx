        ...
        <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
          ...
          <div className="flex items-center justify-center">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center w-10 h-10 font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800"
