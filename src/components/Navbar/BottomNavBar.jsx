    ...
    <nav className="bottom-navbar">
      <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-whitee shadow-navbar rounded bottom-0 left-1/2 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
          ...
          >
            <svg
              className="w-6 h-6 mb-1 text-periwinkle dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
              aria-hidden="true"
            ...
            <span className="text-sm text-center text-periwinkle font-semibold  mt-2 dark:text-gray-300">
              Home
            </span>
          </button>
          ...
          >
            <svg
              className="w-7 h-7 text-periwinkle dark:text-white"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <button
            ...
            data-tooltip-target="tooltip-analysis"
            type="button"
            className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group"
          >
            <svg
